  ...
  const collections: Collection[] = [
    {
      ...
      image: "/images/main/collection/collection1.png",
    },
    {
      id: "2",
      title: "コンパクトに収納",
      text: "鞄につけたり、飾ったりしないガチャガチャは、小分けにして収納しています。",
      image: "/images/main/collection/collection2.png",
    },
    {
      id: "3",
      title: "収納だけじゃない",
      text: "お気に入りのフィギュアは、重ねられるケースに入れて飾っています。",
      image: "/images/main/collection/collection3.png",
    },
  ];
          ...
          {collections.map((collection) => (
            <div>
              ...
              <dd id={"acc" + collection.id} className="current3">
                <Image src={collection.image} width={500} height={400} />
                <div className="text">
